...
const W2N1_CREEP_CONFIGS: CreepConfig[] = [
  ...
  },
  {
    ...
    body: [MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY , WORK, WORK, WORK, WORK, WORK, WORK, WORK],
    maxCount: 1,
    priority: 4,
    needLength: 1,
  },
...
// 导出配置，根据RCL进行调整
export const W2N1_CONFIG = adjustConfigByRCL(w1n1Config, 2); // 假设为高级RCL房间
